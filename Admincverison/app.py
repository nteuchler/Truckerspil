...
breaking_news = ""  # Global variable to store the breaking news
...
def admin():
    ...
    return render_template('admin.html', city_prices=city_prices, cities=cities, selected_city=selected_city)
